...
export const eventPageCopy: Record<Locale, {
  ...
  zh: {
    calendarSection: {
      ...
      title: "本月，和我们在",
      accent: "镜头里见",
      note: "选择有标记的日期查看当天安排。仅可切换至已经配置活动的月份。",
    },
    programSection: {
      number: "02 / Program",
      title: "三种相遇，",
      accent: "三种创作方式",
      note: "悬停、聚焦或点击活动名称展开内容；点击照片进入大图预览。",
    },
  ...
  en: {
    calendarSection: {
      ...
      note: "Choose a marked date to see its schedule. Navigation is limited to months with configured events.",
    },
    programSection: {
      number: "02 / Program",
      title: "Three ways to meet,",
      accent: "three ways to create",
      note: "Hover, focus, or select a program to expand it. Select a photograph for the full-screen viewer.",
    },
    selectedDateLabel: "Selected date · UTC+8",
