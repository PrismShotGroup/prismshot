...
export const socialPlatforms: readonly SocialPlatform[] = [
  {
    ...
    linkNote: { zh: "加群链接 · 待确认", en: "Join link · To be confirmed" },
  ...
  },
  {
    id: "vrchat",
    name: "VRChat",
    account: "PrismShot Group",
    href: "https://hello.vrchat.com/",
    iconSrc: "/icons/social/vrchat.svg",
    linkNote: { zh: "账号名称 · 待确认", en: "Account name · To be confirmed" },
  ...
  },
  {
    id: "discord",
    name: "Discord",
    account: "PrismShot Community",
    href: "https://discord.com/",
    iconSrc: "/icons/social/discord.svg",
    linkNote: { zh: "邀请链接 · 待确认", en: "Invite link · To be confirmed" },
  ...
  },
  {
    ...
    linkNote: { zh: "UID / 主页链接 · 待确认", en: "UID / profile link · To be confirmed" },
...
export const aboutPageCopy: Record<Locale, {
  ...
  zh: {
    ...
    connectSection: {
      ...
      title: "在你常用的平台，",
      accent: "找到我们",
      note: "账号名、外链与二维码均为可替换占位内容；二维码已在静态构建时由同一链接生成。",
    },
    placeholderTag: "介绍占位 · 上线前待替换",
  ...
  en: {
    manifestoSection: {
      number: "01 / Manifesto",
      title: "Let real feeling",
      accent: "cross virtual worlds",
      note: "",
    },
    connectSection: {
      number: "02 / Connect",
      ...
      note: "Account names, links, and codes remain replaceable placeholders. Each QR code is generated from the same link during the static build.",
    },
    placeholderTag: "Draft introduction · Replace before release",
