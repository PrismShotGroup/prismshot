...
export const socialPlatforms: readonly SocialPlatform[] = [
    {
        ...
        qrAlt: {
            zh: "QQ 社群链接二维码",
            en: "QR code for the QQ community link",
        },
        placeholder: false,
    },
    {
        ...
        qrAlt: {
            zh: "VRChat 社群链接二维码",
            en: "QR code for the VRChat community link",
        },
        placeholder: false,
    },
    {
        ...
        qrAlt: {
            zh: "Discord 邀请链接二维码",
            en: "QR code for the Discord invite",
        },
        placeholder: false,
    },
    {
    ...
    },
    {
        ...
        qrAlt: {
            zh: "Bilibili 主页二维码",
            en: "QR code for the Bilibili profile",
        },
        placeholder: false,
    },
];
...
export const teamMembers: readonly TeamMember[] = [
    {
        ...
        portraitAlt: { zh: "林褀的人物照片", en: "Portrait of Linqi" },
    },
    {
        id: "lukij",
        name: "LukiJ",
    ...
    },
    {
        ...
        portraitAlt: { zh: "UMI的人物照片", en: "Portrait of Umi" },
    },
];
...
> = {
    zh: {
        ...
        supportContact:
            "赞助与合作可在 QQ 群联系社团负责人，备注「社团赞助」；所有支持，我们都会在社群内公开致谢。",
        ...
        privacyTitle: "隐私说明",
        privacyBody:
            "本站为静态展示网站，不提供登录、投稿、报名或站内表单，不主动收集访客个人信息。外部社交平台链接与二维码将带你离开本站，其数据处理规则以对应平台的隐私政策为准。正式站点如启用 Cloudflare Web Analytics，将仅用于了解匿名化的基础访问情况。",
    },
    en: {
        manifestoSection: {
            number: "01 / Manifesto",
